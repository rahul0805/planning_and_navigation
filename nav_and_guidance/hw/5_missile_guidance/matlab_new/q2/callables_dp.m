function [tP, yCBP,x_target,x_missile,betas] = callables_dp(t,y0, vt, vu, theta_target, x_missile_ini,x_target_ini)
optPos = odeset('Events', @(t,y)stop_pos(t,y), 'RelTol', 1e-6, 'AbsTol',1e-6);
[tP, yCBP] = ode45(@(t,y)guid_func(t,y, vt, vu, theta_target), t, y0, optPos);
