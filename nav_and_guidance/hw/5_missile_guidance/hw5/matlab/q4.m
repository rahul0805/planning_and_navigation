...
lambda = 1;
[tP5_PP, x_target5_PP, x_missile5_PP,beta5_PP,theta5_PP,R5_PP] = get_pp_rand(t,y0, vt, vu, theta_target, x_missile_ini,x_target_ini, lambda);
lambda = 1.5;
[tP6_PP, x_target6_PP, x_missile6_PP,beta6_PP,theta6_PP,R6_PP] = get_pp_rand(t,y0, vt, vu, theta_target, x_missile_ini,x_target_ini, lambda);
lambda = 2;
[tP7_PP, x_target7_PP, x_missile7_PP,beta7_PP,theta7_PP,R7_PP] = get_pp_rand(t,y0, vt, vu, theta_target, x_missile_ini,x_target_ini, lambda);
lambda = 2.50;
[tP8_PP, x_target8_PP, x_missile8_PP,beta8_PP,theta8_PP,R8_PP] = get_pp_rand(t,y0, vt, vu, theta_target, x_missile_ini,x_target_ini, lambda);
%% plotting 
...
saveas(fig3,'./plots/q4_plot_traj.png');
savefig(fig3,'./plots/q4_plot_traj');
hold off;
...
legend('DP','lambda = 1.5','lambda = 2','lambda = 2.5');
saveas(fig4,'./plots/q4_plot_dist.png');
savefig(fig4,'./plots/q4_plot_dist');
hold off;
