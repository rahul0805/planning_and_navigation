function [tP, x_target, x_missile,beta,theta,R] = get_pp(t,y0, vt, vu, theta_target, x_missile_ini,x_target_ini, lambda)

optPos = odeset('Events', @(t,y)stop_pos_pp(t,y), 'RelTol', 1e-6, 'AbsTol',1e-6);
[tP, yCBP] = ode45(@(t,y)guid_func_pp(t,y, vt, vu, theta_target,lambda), t, y0, optPos);
